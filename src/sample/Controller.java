...
//        No_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//        time_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//        source_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//        target_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//        protocol_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//        length_col.prefWidthProperty().bind(packetTable.widthProperty().divide(6.0));
//
//
